...
import java.awt.Toolkit; //nos da el tamaño de la ventana
import java.awt.event.*; //interactuar con las teclas los eventos
import java.util.ArrayList;
import java.util.Random;
import java.awt.Point; //el punto en el plano
